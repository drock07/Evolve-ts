import { global, p_on, sizeApproximation, seededRandom } from './vars';
import { vBind, clearElement, popover, powerCostMod, spaceCostMultiplier, messageQueue, powerModifier, timeFormat, calcPrestige, clearPopper } from './functions';
import { spatialReasoning } from './resources';
import { actions, payCosts, initStruct, powerOnNewStruct, setAction, storageMultipler, drawTech, bank_vault } from './actions';
import { checkRequirements, incrementStruct, piracy, ascendLab} from './space';
import { mechRating, checkWarlordAchieve } from './portal';
import { jobScale, workerScale } from './jobs';
import { production, highPopAdjust } from './prod';
import { loc } from './locale';
import { armyRating, armorCalc, garrisonSize, mercCost, soldierDeath } from './civics';
import { govActive } from './governor';
import { races, traits, traitCostMod, racialTrait } from './races';
import { addSmelter } from './industry'
