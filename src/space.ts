import { save, global, seededRandom, webWorker, keyMultiplier, sizeApproximation, p_on, support_on, int_on, gal_on } from './vars';
import { vBind, messageQueue, clearElement, popover, clearPopper, flib, powerModifier, powerCostMod, calcPrestige, spaceCostMultiplier, darkEffect, eventActive, calcGenomeScore, randomKey, getTraitDesc, deepClone, get_qlevel, timeFormat } from './functions';
import { unlockAchieve, unlockFeat, universeAffix } from './achieve';
import { races, traits, genus_def, genusVars, planetTraits, biomes, traitCostMod } from './races';
import { spatialReasoning, unlockContainers, drawResourceTab, atomic_mass } from './resources';
import { loadFoundry, jobScale } from './jobs';
import { defineIndustry, addSmelter } from './industry';
import { garrisonSize, describeSoldier, checkControlling, govTitle } from './civics';
import { actions, payCosts, powerOnNewStruct, initStruct, setAction, setPlanet, storageMultipler, drawTech, bank_vault, updateDesc, actionDesc, templeEffect, templeCount, casinoEffect, wardenLabel, buildTemplate, structName } from './actions';
import { outerTruthTech, syndicate, drawShipYard } from './truepath';
import { production, highPopAdjust } from './prod';
import { defineGovernor, govActive } from './governor';
import { ascend, terraform, apotheosis } from './resets';
