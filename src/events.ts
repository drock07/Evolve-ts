import { global, seededRandom, p_on, support_on, sizeApproximation } from './vars';
import { loc } from './locale';
import { races, traits, fathomCheck, blubberFill } from './races';
import { govTitle, garrisonSize, armyRating } from './civics';
import { housingLabel, drawTech, actions } from './actions';
import { flib, drawPet } from './functions';
import { tradeRatio } from './resources';
import { checkControlling, soldierDeath } from './civics';
import { govActive } from './governor';
import { unlockAchieve } from './achieve';
