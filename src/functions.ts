import { global, save, message_logs, message_filters, webWorker, keyMultiplier, intervals, resizeGame, atrack, p_on, quantum_level, tmp_vars } from './vars';
import { loc } from './locale';
import { races, traits, genus_def, traitSkin, fathomCheck } from './races';
import { actions, actionDesc } from './actions';
import { jobScale } from './jobs';
import { universe_affixes } from './space';
import { arpaAdjustCosts, arpaProjectCosts } from './arpa';
import { gridDefs } from './industry';
import { govActive } from './governor';
import { govEffect } from './civics';
import { highPopAdjust } from './prod';
import { universeLevel, universeAffix, alevel } from './achieve';
