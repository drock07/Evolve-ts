...
import { infoBoxBuilder, sideMenu } from './functions';
import { calcPillar } from './../functions';
import { mechSize, mechWeaponPower, mechCost, terrainEffect, monsters } from './../portal';
