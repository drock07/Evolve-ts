import { global, set_alevel, set_ulevel } from './vars';
import { clearElement, popover, flib, calc_mastery, masteryType, calcPillar, svgIcons, svgViewBox, format_emblem, getBaseIcon, sLevel, vBind, calcQueueMax, calcRQueueMax, messageQueue, eventActive, easterEgg, getHalloween, trickOrTreat, harmonyEffect } from './functions';
import { races, genus_def } from './races';
import { actions } from './actions';
import { universe_affixes, universe_types, piracy } from './space';
import { monsters } from './portal';
