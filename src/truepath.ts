import { global, p_on, support_on, sizeApproximation, keyMap } from './vars';
import { vBind, clearElement, popover, clearPopper, messageQueue, powerCostMod, powerModifier, spaceCostMultiplier, deepClone, calcPrestige, flib, darkEffect, adjustCosts, get_qlevel, timeCheck, timeFormat, buildQueue } from './functions';
import { races, traits, orbitLength } from './races';
import { spatialReasoning, unlockContainers } from './resources';
import { armyRating, garrisonSize, soldierDeath } from './civics';
import { jobScale, job_desc, loadFoundry, limitCraftsmen } from './jobs';
import { production, highPopAdjust } from './prod';
import { actions, payCosts, powerOnNewStruct, setAction, drawTech, bank_vault, buildTemplate, casinoEffect, housingLabel, structName, initStruct } from './actions';
import { fuel_adjust, int_fuel_adjust, spaceTech, renderSpace, checkRequirements, incrementStruct, planetName } from './space';
import { defineGovernor, removeTask, govActive } from './governor';
import { defineIndustry, nf_resources, addSmelter, setupRituals, cancelRituals } from './industry';
import { arpa } from './arpa';
import { matrix, retirement, gardenOfEden } from './resets';
import { traitCostMod } from './races';
