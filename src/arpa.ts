import { global, keyMultiplier, sizeApproximation, srSpeak, p_on, support_on } from './vars';
import { clearElement, popover, clearPopper, flib, fibonacci, eventActive, timeFormat, vBind, messageQueue, adjustCosts, calcQueueMax, calcRQueueMax, buildQueue, calcPrestige, calc_mastery, darkEffect, easterEgg, trickOrTreat, getTraitDesc, removeFromQueue, arpaTimeCheck, deepClone } from './functions';
import { actions, updateQueueNames, drawTech, drawCity, addAction, removeAction, wardenLabel, checkCosts, structName } from './actions';
import { races, traits, cleanAddTrait, cleanRemoveTrait, combineTraits, traitSkin, fathomCheck, planetTraits, setTraitRank, traitRank } from './races';
import { renderSpace } from './space';
import { drawMechLab } from './portal';
import { govActive, defineGovernor } from './governor';
import { highPopAdjust } from './prod';
import { unlockFeat } from './achieve';
